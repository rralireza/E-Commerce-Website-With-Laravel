...
@section('container')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('updateBrandProcess' , $brand) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">Brand Title</label>
                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Brand Title" value="{{ $brand->name }}">
                </div>
            </div>
            ...
            <img src="{{ str_replace('public' , '/storage' , $brand->image) }}" alt="" width="100">
