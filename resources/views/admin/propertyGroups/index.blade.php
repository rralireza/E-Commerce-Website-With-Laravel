...
@section('title') List of Property Groups @endsection
@section('mainTitle') Property Groups @endsection
@section('container')
    <div class="row">
        <div class="col-12">
            <div class="card">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        @foreach($propertyGroups as $property)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('updatePropertyGroup' , $property) }}" class="btn btn-sm-square btn-success">Edit</a>
                                </td>
                                <td>
                                    <form action="{{ route('deletePropertyGroup' , $property) }}" method="post">
                                        @csrf
                                        @method('DELETE')
