...
@section('mainTitle') Roles @endsection
@section('container')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">You can manage your system Roles.</h3>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        @foreach($roles as $role)
                            <tr>
                                <td>{{ $role->title }}</td>
                                <td>
                                    <a href="{{ route('updateRole' , $role) }}" class="btn btn-sm-square btn-success">Edit</a>
                                </td>
                                <td>
